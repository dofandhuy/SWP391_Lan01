...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; margin:0; padding:0; background:#f4f6f9; display:flex; }
        .sidebar { width:220px; background:#3f51b5; min-height:100vh; padding:20px 0; color:white; box-shadow:2px 0 5px rgba(0,0,0,0.1); }
        ...
        .sidebar a { display:block; padding:12px 20px; margin:5px 10px; color:#c5cae9; text-decoration:none; border-radius:6px; transition:0.3s; font-weight:500; }
        .sidebar a:hover { background:#303f9f; color:#fff; }
        .sidebar a.active { background:#ff9800; color:#fff; box-shadow:0 2px 5px rgba(0,0,0,0.2); }
        ...
        <div class="container">
            ...
            <form action="EditQuestionServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="category" name="category" value="<%= question.getCategory() %>" required>
                </div>
<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    %>
                        <div class="answer-option">
                            ...
                            <input type="radio" name="correctAnswer" value="<%= o.getAnswerText() %>"
