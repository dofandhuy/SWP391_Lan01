...
public class PayServlet extends HttpServlet {
   ...
   private static final String vnp_TmnCode = "RTIAZ1HY";
    ...
    private static final String vnp_ReturnUrl = "http://localhost:9999/WebApplication1/payment_return";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        PaymentRequest paymentDetails = dao.getPaymentRequestById(paymentId); 
        ...
        String vnp_Amount = String.valueOf(amountAsLong); 
