                ...
                <section class="learn-section">
                    ...
                    <div class="modules-container">
                        ...
                        <div class="module-box">
                            <button class="module-header" onclick="toggleLessons(1)">
                                <i class="fa-solid fa-chevron-right"></i>
                                Module 1: Introduction to AI
                            </button>
                            <ul id="lesson-list-1" class="lesson-list">
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 1: What is AI?</li>
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 2: History and Milestones</li>
                            </ul>
                        </div>

                        <!-- Module 2 -->
                        <div class="module-box">
                            <button class="module-header" onclick="toggleLessons(2)">
                                <i class="fa-solid fa-chevron-right"></i>
                                Module 2: Machine Learning Basics
                            </button>
                            <ul id="lesson-list-2" class="lesson-list">
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 1: Supervised vs Unsupervised Learning</li>
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 2: Regression and Classification</li>
                            </ul>
                        </div>

                        <!-- Module 3 -->
                        <div class="module-box">
                            <button class="module-header" onclick="toggleLessons(3)">
                                <i class="fa-solid fa-chevron-right"></i>
                                Module 3: Deep Learning Concepts
                            </button>
                            <ul id="lesson-list-3" class="lesson-list">
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 1: Neural Networks Overview</li>
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 2: CNNs and RNNs Explained</li>
                            </ul>
                        </div>

                        <!-- Module 4 -->
                        <div class="module-box">
                            <button class="module-header" onclick="toggleLessons(4)">
                                <i class="fa-solid fa-chevron-right"></i>
                                Module 4: AI in Practice
                            </button>
                            <ul id="lesson-list-4" class="lesson-list">
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 1: AI in Healthcare</li>
                                <li><i class="fa-regular fa-file-lines"></i> Lesson 2: AI in Finance</li>
                            </ul>
                        </div>
