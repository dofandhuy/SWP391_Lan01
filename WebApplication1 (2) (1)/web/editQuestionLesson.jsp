...
<%
    ...
    Integer lessonID = (Integer) request.getAttribute("lessonID"); // Lấy lessonID từ request

    if (question == null || options == null || lessonID == null) {
...
<div class="main">
    <div class="container">
        <h2>Edit Question</h2>
        <form action="<%=request.getContextPath()%>/EditQuestionLessonServlet" method="post">
            ...
            <div class="form-group">
                ...
                <% for (AnswerOption o : options) { %>
                    <div class="answer-option">
                        ...
                        <input type="checkbox" name="correctAnswer" value="<%= o.getAnswerID() %>"
            ...
            <a href="<%=request.getContextPath()%>/LessonDetailServlet?lessonId=<%= lessonID %>" class="btn-back">Back</a>
        </form>
    </div>
</div>
</body>
