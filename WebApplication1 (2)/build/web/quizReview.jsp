    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .back-btn-inline:hover { background-color: #0056b3; }
            .review-header h1 {
                font-size: 1.4rem;
                font-weight: 700;
                color: #222;
            ...
            /* ========== QUESTIONS ========== */
            .question-list { padding: 30px 40px; }
            .question-item {
            ...
            .question-number { font-weight: 700; color: #007bff; margin-right: 10px; }
            .question-text { flex: 1; font-size: 1.05rem; color: #222; }
            .points-fraction { font-size: 0.9rem; color: #666; white-space: nowrap; }
            ...
            /* ========== FILL BLANK ========== */
            .fill-blank-review { margin-top: 8px; font-size: 1rem; }
            ...
            @media (max-width: 600px) {
                .review-header, .question-list { padding: 20px; }
                .question-item { padding: 15px; }
                .back-btn-inline { padding: 8px 14px; font-size: 0.9rem; }
            }
        </style>
    </head>
