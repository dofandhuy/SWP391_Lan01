...
public class CourseDAO {
    ...
    public boolean deleteCourseWithModules(int courseId) {
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            try (
                    PreparedStatement psGetModules = conn.prepareStatement(getModuleIdsSQL); PreparedStatement psGetLessons = conn.prepareStatement(getLessonIdsSQL); PreparedStatement psDeleteLessonVideos = conn.prepareStatement(deleteLessonVideosSQL); PreparedStatement psDeleteLessonDocs = conn.prepareStatement(deleteLessonDocumentsSQL); PreparedStatement psDeleteStudentProgress = conn.prepareStatement(deleteStudentProgressSQL); PreparedStatement psDeleteLessons = conn.prepareStatement(deleteLessonsSQL); PreparedStatement psDeleteModules = conn.prepareStatement(deleteModulesSQL); PreparedStatement psDeleteEnrollments = conn.prepareStatement(deleteEnrollmentsSQL); PreparedStatement psDeleteCourseCart = conn.prepareStatement(deleteCourseCartSQL); PreparedStatement psDeletePayment = conn.prepareStatement(deletePaymentRequestSQL); PreparedStatement psDeleteCourse = conn.prepareStatement(deleteCourseSQL)) {
