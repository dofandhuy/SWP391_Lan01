...
public class DoQuizServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            QuizDetailsDTO details = quizService.getQuizDetailsForStudent(quizId, studentId);
            ...
            int newAttemptId = attemptDAO.createAttempt(studentId, quizId);
            ...
            quizData.setPointPerQuestion(details.getPointPerQuestion()); // <-- ĐÃ SỬA
