        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            try (
                ...
                while (rsLessons.next()) {
                    ...
                    // 2️⃣ Xóa các dữ liệu liên quan tới lesson
                ...
                // 3️⃣ Xóa tất cả lesson của module
                ...
                affected = psDeleteModule.executeUpdate();
