...
public class EditQuizServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           Integer quizCategoryID = quiz.getCategoryID();

// Nếu category là "All" (ví dụ categoryID = null hoặc 0), thì không lọc, hiển thị toàn bộ question bank
if (quizCategoryID != null && quizCategoryID != 0) {
    questionBank.removeIf(q -> !Objects.equals(q.getCategoryID(), quizCategoryID));
}
