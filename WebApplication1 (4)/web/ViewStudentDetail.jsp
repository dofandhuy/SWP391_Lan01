            ...
            <aside class="lms-sidebar">
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li><a href="CourseRequestServlet"><i class="fas fa-book-open"></i> Course Requests</a></li>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="course" items="${enrolledCourses}" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 100%; background-color: #e9ecef; border-radius: 8px; height: 20px; position: relative;">
                                            <div class ="progress-bar" style="
                                                 width: ${course.progress}%;
                                                 background-color:
                                                 <c:choose>
                                                     <c:when test='${course.progress >= 80}'>#28a745</c:when>     <%-- xanh lá nếu gần hoàn thành --%>
                                                     <c:when test='${course.progress >= 50}'>#ffc107</c:when>     <%-- vàng nếu trung bình --%>
                                                     <c:otherwise>#dc3545</c:otherwise>                           <%-- đỏ nếu thấp --%>
                                                 </c:choose>;
                                                 height: 100%;
                                                 border-radius: 8px;
                                            ...
                                            <span style="
                                                  ...
                                                  font-weight: 500;
                                                  color: #212529;">
                                                <fmt:formatNumber value="${course.progress}" type="number" maxFractionDigits="1"/>%
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${course.status == 'Enrolled'}">
