...
<body>
    ...
    <div class="main-container">
        ...
        <fieldset>
            ...
            <button class="btn btn-menu" onclick="location.href='admin/questionAction'" type="button">Question Manage</button>
        </fieldset>

        <button class="btn btn-logout" onclick="location.href='Signin.jsp'" type="button">Log Out</button>
    </div>
