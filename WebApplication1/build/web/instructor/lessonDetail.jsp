        ...
        <div class="main">
            ...
            <c:choose>
                                ...
                                <ul style="list-style:none; padding-left:0;">
                                    <c:forEach var="q" items="${questions}">
                                        <li style="margin-bottom:15px; padding:10px; background:#f1f3f5; border-radius:6px;">
                                            <strong>Q${q.questionID}:</strong> ${q.questionText} <br>
                                            ...
                                            <a href="${pageContext.request.contextPath}/DeleteQuestionServlet?questionId=${q.questionID}&lessonId=${lesson.lessonID}"
                ...
                <c:when test="${lesson.lessonType == 'quiz'}">
                    <div class="section">
                        <h3><i class="fa-solid fa-circle-question"></i> Lesson Quiz</h3>
                        <c:choose>
                            <c:when test="${not empty quiz}">
                                <p><strong>${quiz.title}</strong></p>
                                <p>${quiz.description}</p>
                                <a href="quizDetail?quizId=${quiz.quizID}" 
                                   style="text-decoration:none; background:#22c1c3; color:white; padding:8px 14px; border-radius:6px;">
                                    View Quiz
                                </a>
                            </c:when>
                            <c:otherwise>
                                <p>No quiz assigned.</p>
                                <button type="button" onclick="openAssignModal()">Assign Quiz</button>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </c:when>
